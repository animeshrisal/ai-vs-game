...
class FlappyBirdApp(object):
    ...
    def on_render(self):
        ...
        for bird in self.birds:
            ...
            #disp_tools.displayStat(SCREEN, bird.neural_network.species_id, text="species")
            #disp_tools.displayStat(SCREEN, bird.neural_network.generation_id, text="generation")
